<template>
  <v-container class="pt-8">
    ...
    <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection
      ...
      of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank">TermsFeed Privacy Policy
        Generator</a>.</p>
    ...
    <ul>
      ...
      <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
          &quot;Our&quot; in this Agreement) refers to LetterBot.</p>
      </li>
      <li>
      ...
      <li>
        <p><strong>Website</strong> refers to LetterBot, accessible from <a href="https://letterbot.webturtlelabs.com"
                                                                            rel="external nofollow noopener"
                                                                            target="_blank">https://letterbot.webturtlelabs.com</a>
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: webturtlelabs23@gmail.com</li>
    </ul>
  </v-container>
</template>
